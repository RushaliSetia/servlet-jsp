...
public class DateAndTime extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("Question<input type='text' name= 'question'><br/>");
		pw.print("Answer<input type='text' name= 'answer'><br/>");
		pw.print("<input type='hidden' name= 'topic' value="+t+"><br/>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(buttonName.equals("Enter more"))
		{
			...
			response.sendRedirect("DateAndTime?topicName="+topic+"");
