...
public class StringAndBuffer extends HttpServlet {
	private static final long serialVersionUID = 1L;
  
    public StringAndBuffer() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<html><body>");
		pw.print("<h1 align='center'>Date And Time</h1>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(buttonName.equals("Enter more"))
		{
			...
			response.sendRedirect("StringAndBuffer?topicName="+topic+"");
